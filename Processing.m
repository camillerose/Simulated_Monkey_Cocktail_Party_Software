        ...
        if Marm.isUpEdgePhee(prev_isphee)
           ...
           % update the GUIs events 
              ...
              if (Marm.start_time - primary_obj.end_time) <= Marm.anti_win && ...
                    ...
                    set(DataGUI.calls_to_primary, 'String', num2str(Marm.live_anti_calls));
                    drawnow('expose')
             % call to primary test
              elseif (Marm.start_time - primary_obj.end_time) <= Marm.anti_win && ...
                    ...
                    set(DataGUI.calls_to_primary_test, 'String', num2str(Marm.live_probe_primary_response));
                    drawnow('expose')
             % call to spontDis anti or spont
              elseif (Marm.start_time - spont_dis_obj.end_time) <= Marm.anti_win && ...
                    ...
                    set(DataGUI.calls_to_spontDis, 'String', num2str(Marm.live_anti_2_distracter));
                    drawnow('expose')
              ...
              elseif (Marm.start_time - spont_dis_obj.end_time) <= Marm.anti_win && ...
                    ...
                    set(DataGUI.calls_to_spontDis_test, 'String', num2str(Marm.live_probe_spontDis_response));
                    drawnow('expose')
              ...
              elseif (Marm.start_time - antiDis1_obj.end_time) <= Marm.anti_win && ...
                    ...
                    set(DataGUI.calls_to_antiDis1, 'String', num2str(Marm.live_anti_2_antiDis1));
                    drawnow('expose')
              ...
              elseif (Marm.start_time - antiDis1_obj.end_time) <= Marm.anti_win && ...
                    ...
                    set(DataGUI.calls_to_antiDis1_test, 'String', num2str(Marm.live_probe_antiDis1_response));
                    drawnow('expose')
              ...
              elseif (Marm.start_time - antiDis2_obj.end_time) <= Marm.anti_win && ...
                    ...
                    set(DataGUI.calls_to_antiDis2, 'String', num2str(Marm.live_anti_2_antiDis2));
                    drawnow('expose')
              ...
              elseif (Marm.start_time - antiDis2_obj.end_time) <= Marm.anti_win && ...
                    ...
                    set(DataGUI.calls_to_antiDis2_test, 'String', num2str(Marm.live_probe_antiDis2_response));
                    drawnow('expose')
              % spontaneous call      
              else
                    ...
                    set(DataGUI.spont_calls, 'String', num2str(Marm.live_spont_calls));
                    drawnow('expose')
              end
              ...
              set(DataGUI.total_calls, 'String', num2str(Marm.pheeCallCounter));
              drawnow('expose');
